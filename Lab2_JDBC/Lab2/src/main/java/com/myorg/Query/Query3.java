...
public class Query3 {
    // Сделать выборку Издателей и изменить имя определенного Издателя
    public static void main(String[] args) {
        ...
        try{
            ...
            String query1Publisher = "UPDATE publishers " + "SET publisherName = 'Changed Name' WHERE publisherID in (12)";
